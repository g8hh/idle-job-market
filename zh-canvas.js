...
var cnItems = {
    ...
    "Monitoring": "监控",
    "Physical Prowess": "身体素质",
    "Keyboard Ninja": "键盘忍者",
    "Team Optimization": "团队优化",
    "Perfectionism": "完美主义",
    "Corporate Leadership": "企业领导",
    "Fullscreen": "全屏",
    "Government Funding": "政府资金",
    "Hardship": "艰辛",
    "Monopoly": "垄断",
    "Physical": "体力",
    "Engines Of Clockwork": "发条引擎",
    "Education": "教育",
    "The Hierarchy": "层次结构",
    "Recruitment": "招聘",
    "Fitness": "健身",
    ...
    "Keyboard": "键盘",
    "Show full number in cash.": "显示完整的现金号码。",
    "* Chrome is recommended over Firefox for smoother performance.": "* 建议使用 Chrome 而非 Firefox，以获得更流畅的性能。",
    "Join our Discord Channel": "加入我们的 Discord 频道",
